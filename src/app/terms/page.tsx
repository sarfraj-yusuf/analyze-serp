      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-white/10 space-y-6 text-sm text-slate-700 dark:text-gray-300 leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">2. Acceptable Use & Fair Usage Limits</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">3. Pro Plan Subscriptions & Billing</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">4. Disclaimer of Search Engine Warranties</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">5. Governing Law</h2>
