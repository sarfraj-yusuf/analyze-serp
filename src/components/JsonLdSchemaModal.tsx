        ...
        <div className="p-4 sm:p-5 border-b border-slate-200 dark:border-white/10 flex items-center justify-between gap-3 shrink-0 bg-slate-50/70 dark:bg-slate-900/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 id="schema-modal-title" className="text-base font-bold text-slate-800 dark:text-slate-100">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-1.5 rounded-lg text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors cursor-pointer"
              title="Close modal"
            >
              <X className="w-5 h-5" />
            </button>
              ...
              <div className="space-y-3">
                ...
                {faqs.length === 0 ? (
                  <div className="p-6 text-center border-2 border-dashed border-slate-200 dark:border-white/10 rounded-xl space-y-2">
                    <HelpCircle className="w-8 h-8 text-slate-500 dark:text-slate-400 mx-auto" />
                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <div className="flex items-center gap-1">
                              <button
                                ...
                                className="p-1 rounded text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer"
                              ...
                              <button
                                ...
                                className="p-1 rounded text-slate-500 hover:text-rose-600 dark:text-slate-400 transition-colors cursor-pointer"
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  ...
                                  {isExpanded ? (
                                    <ChevronUp className="w-3.5 h-3.5 text-slate-500 dark:text-slate-400 shrink-0" />
                                  ) : (
