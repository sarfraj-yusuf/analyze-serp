...
export const SerpSocialSimulator: React.FC<SerpSocialSimulatorProps> = ({ meta, initialUrl }) => {
  ...
  return (
    <div className="glass-panel hero-input-dock rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-white/10 space-y-6">
      {/* Simulator Toolbar */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          {/* Platform Tab Selectors - Tactile Segmented Control */}
          <div role="tablist" aria-label="SERP and Social Preview Platforms" className="flex items-center gap-1 p-1 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-slate-200/80 dark:border-white/[0.06] overflow-x-auto">
            <button
              role="tab"
            ...
            <button
              role="tab"
              aria-selected={activePlatform === 'facebook'}
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-white/[0.08] min-h-[220px] flex flex-col justify-center shadow-xs">
              ...
              <div className="max-w-[360px] mx-auto space-y-2 font-sans p-3 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#0b0f19]">
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <div className="truncate">
                    <div className="text-[12px] font-bold text-slate-800 dark:text-slate-100 leading-tight">{hostname}</div>
            ...
            {activePlatform === 'facebook' && (
              <div className="max-w-[480px] mx-auto rounded-xl border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-[#131b2e] overflow-hidden shadow-sm">
                ...
                <div className="p-3.5 space-y-1">
                  ...
                  <div className="text-sm font-bold text-slate-800 dark:text-slate-100 line-clamp-1">{title}</div>
            ...
            {activePlatform === 'twitter' && (
              <div className="max-w-[480px] mx-auto rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#0b0f19] overflow-hidden shadow-sm">
                ...
                <div className="p-3.5 space-y-1">
                  <div className="text-xs font-bold text-slate-800 dark:text-slate-100 line-clamp-1">{title}</div>
