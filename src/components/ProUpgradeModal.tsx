  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        ...
        className="relative w-full max-w-xl bg-white dark:bg-slate-900 rounded-2xl p-6 sm:p-7 border border-slate-200/90 dark:border-white/10 shadow-2xl space-y-6 overflow-hidden text-slate-800 dark:text-slate-100"
      >
        ...
        <button
          onClick={onClose}
          aria-label="Close pricing details modal"
        ...
        <div className="p-5 rounded-2xl bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/40 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
          ...
          <button
            onClick={onClose}
            className="px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-md shadow-emerald-600/20 transition-all cursor-pointer shrink-0 w-full sm:w-auto"
          >
