      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200/70 dark:border-white/[0.06]">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-semibold uppercase tracking-wider bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20">
        ...
        {results && results.length > 0 && (
          ...
          >
            <button
              ...
              className="p-1.5 sm:p-2 rounded-lg text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors cursor-pointer shrink-0 self-start sm:self-auto"
            >
              {isCopied ? (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        >
          ...
          <div className="flex items-baseline gap-2">
            <span className="font-mono text-2xl sm:text-3xl font-bold text-slate-800 dark:text-slate-100 tabular-nums">
              {highImpactCount}
            </span>
        ...
        <div
          ...
          className="p-4 rounded-xl bg-emerald-50/80 dark:bg-emerald-950/25 border border-emerald-200/80 dark:border-emerald-900/40 hover:border-emerald-400 dark:hover:border-emerald-700/60 transition-all cursor-pointer group shadow-2xs"
        >
          <div className="flex items-center justify-between mb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {top3Opportunities.map((opp, idx) => (
              ...
              >
                ...
                <div className="pt-2 border-t border-slate-100 dark:border-white/5 flex items-center justify-between text-[11px] text-emerald-600 dark:text-emerald-400 font-semibold">
